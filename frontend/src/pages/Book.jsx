    ...
    return (
        <div className='flex flex-col items-center '>
            ...
            <div className='w-64 h-32 bg-green-100 rounded-lg shadow-lg   text-black'>
                ...
                <p className=' px-5'>please select ur sport</p>
                <button onClick={toggleDropdown} className="inline-flex justify-center w-full rounded-md border border-gray-300 bg-white py-2 px-4 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500">click to select sport</button>
      {/* Dropdown Menu */}
        {isOpen && (
