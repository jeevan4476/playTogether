function Carousel() {
    return (
        <div className="flex flex-col items-center space-y-8 p-6 bg-white shadow-lg rounded-lg max-w-4xl mx-auto mt-8 transition">
            ...
            <div className="bg-gray-200 w-full h-64 flex items-center justify-center rounded-lg shadow-inner overflow-hidden">
                <img
                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRPJSj23elXsNSgAGXfXk3UNPsBQvfBMZgOG0_JodJZMca0L-hW75mXWXLVI8JFGH8RgU4&usqp=CAU"
                    alt="Football"
